...
public class RecommendationFactory {
	...
	public List<Recommendation> createDefaultRecommendations(final Resume resume) {
		...
		recommendations.add(dao.saveOrCreateNew(new Recommendation(
			resume,
			"Erick Hallick",
		...
		recommendations.add(this.dao.saveOrCreateNew(new Recommendation(
			resume,
			"Aditya Prakash",
		...
		recommendations.forEach(recommendation -> {
			Recommendation ref = dao.saveOrCreateNew(recommendation);
			LOG.info("Saved {}", ref);
		});
