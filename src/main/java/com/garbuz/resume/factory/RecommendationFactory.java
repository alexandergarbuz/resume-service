...
public class RecommendationFactory {
	...
	public List<Recommendation> createDefaultRecommendations(final Resume resume) {
		...
		recommendations.add(dao.saveAndFlush(new Recommendation(
			...
			"https://www.linkedin.com/in/erick-hallick-498a8a5/",
			"Erick-Hallick-Avatar-150x150.jpg"
		)));
		recommendations.add(this.dao.saveAndFlush(new Recommendation(
			...
			"https://www.linkedin.com/in/aditya-prakash-csm/",
			"Aditya-Prakash-Avatar-150x150.jpg"
		)));
		recommendations.add(this.dao.saveAndFlush(new Recommendation(
			resume,
			"Jeff Fletcher",
			...
			"https://www.linkedin.com/in/jeff-fletcher-01b5b44/",
			"Jeff-Fletcher-Avatar-150x150.jpg"
		)));
