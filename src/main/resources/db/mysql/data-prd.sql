...
--
-- Host: database-1.cbcskeq2wn7n.us-east-2.rds.amazonaws.com    Database: resume_manager_db
-- ------------------------------------------------------
...
--
-- Dumping data for table `contact_information_seq`
--

LOCK TABLES `contact_information_seq` WRITE;
/*!40000 ALTER TABLE `contact_information_seq` DISABLE KEYS */;
INSERT INTO `contact_information_seq` VALUES (51);
/*!40000 ALTER TABLE `contact_information_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `summary_seq` WRITE;
/*!40000 ALTER TABLE `summary_seq` DISABLE KEYS */;
INSERT INTO `summary_seq` VALUES (51);
/*!40000 ALTER TABLE `summary_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-24  8:28:44
